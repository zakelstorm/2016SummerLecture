      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <form action="list" method="post" class="navbar-form navbar-right">
            <input type="text" value="<%= keyword %>" name="keyword" class="form-control" placeholder="Search...">
		...
		<form action="addCart" method="post">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              %>
                <tr>
                  <td><input type = "checkbox" name ="checkBook" value="<%= tmp.getBisdn()%>"></td><!--  name은 구분하게 해주는 인자이고 value는 해당 name에 해당하는 값, 즉 넘겨주는 값을 의미 -->
